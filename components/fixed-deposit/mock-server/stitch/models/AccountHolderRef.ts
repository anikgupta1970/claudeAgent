...
export type AccountHolderRef = {
    ...
    /**
     * Identifier of the form instruction with customer details.<br>This field is required when type is 'ref' ; otherwise, it will be ignored even if provided.<br>Must match exactly one instruction ID of type 'create_ind_customer'.
     */
    ref?: string;
};
