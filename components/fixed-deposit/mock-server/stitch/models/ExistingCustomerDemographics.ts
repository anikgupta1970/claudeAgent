...
/**
 * Demographic information about the existing individual
 */
export type ExistingCustomerDemographics = {
    /**
    ...
    /**
     * Family information including mother's maiden name, father's name, and spouse's name
     */
    family?: Family;
    /**
