export default {
  step1: {
    ...
    mobileHelpText: "परीक्षण के लिए मोबाइल नंबर: 9876543210",
    dateOfBirth: "जन्म तिथि",
    dobHelpText: "परीक्षण के लिए जन्म तिथि: 01/01/1990 (MM/DD/YYYY)",
    dobPlaceholder: "MM/DD/YYYY",
    pan: "Pan Number",
    panPlaceholder: "जैसे ABCDE1234F",
    panHelpText: "अपना 10 अक्षरों का पैन नंबर दर्ज करें।",
    verifyUsing: "सत्यापन का तरीका",
    debitCardNumber: "डेबिट कार्ड नंबर",
    debitCardPlaceholder: "1234 5678 9012 3456",
    debitCardHelpText: "अपना 16 अंकों का डेबिट कार्ड नंबर दर्ज करें।",
    ucic: "UCIC",
    ucicPlaceholder: "जैसे 1234567890",
    ucicHelpText: "अपना UCIC दर्ज करें",
    password: "पासवर्ड",
    passwordPlaceholder: "पासवर्ड दर्ज करें",
    passwordHelpText: "अपना पासवर्ड दर्ज करें",
    ...
    errors: {
      ...
      validMobileRequired: "वैध मोबाइल नंबर आवश्यक है",
      panRequired: "पैन आवश्यक है",
      debitCardRequired: "डेबिट कार्ड नंबर आवश्यक है",
      ucicRequired: "UCIC आवश्यक है",
  ...
  step2: {
    ...
    maturityDoNotRenew: "नवीनीकरण न करें",
    maturityRenewPrincipal: "मूलधन नवीनीकरण",
  ...
  otp: {
    ...
    sentToPhone: "ओटीपी {{phoneNumber}} पर भेजा गया है",
    sentToDevice: "ओटीपी आपके पंजीकृत डिवाइस पर भेजा गया है",
    testingHint: "परीक्षण के लिए, कृपया ओटीपी का उपयोग करें: {{otp}}",
    errors: {
