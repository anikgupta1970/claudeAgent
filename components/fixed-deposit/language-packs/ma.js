export default {
  step1: {
    ...
    mobileHelpText: "चाचणीसाठी मोबाइल क्रमांक: 9876543210",
    dateOfBirth: "जन्म तारीख",
    dobHelpText: "चाचणीसाठी जन्म तारीख: 01/01/1990 (MM/DD/YYYY)",
    dobPlaceholder: "MM/DD/YYYY",
    pan: "पॅन नंबर",
    panPlaceholder: "उदा. ABCDE1234F",
    panHelpText: "तुमचा 10 अक्षरी पॅन क्रमांक प्रविष्ट करा.",
    verifyUsing: "सत्यापनाचा प्रकार",
    debitCardNumber: "डेबिट कार्ड क्रमांक",
    debitCardPlaceholder: "1234 5678 9012 3456",
    debitCardHelpText: "तुमचा 16 अंकी डेबिट कार्ड क्रमांक प्रविष्ट करा.",
    ucic: "UCIC",
    ucicPlaceholder: "उदा. 1234567890",
    ucicHelpText: "तुमचा UCIC प्रविष्ट करा",
    password: "पासवर्ड",
    passwordPlaceholder: "पासवर्ड प्रविष्ट करा",
    passwordHelpText: "तुमचा पासवर्ड प्रविष्ट करा",
    loading: "लोड होत आहे...",
    ...
    errors: {
      ...
      validMobileRequired: "वैध मोबाइल क्रमांक आवश्यक आहे",
      panRequired: "पॅन आवश्यक आहे",
      debitCardRequired: "डेबिट कार्ड क्रमांक आवश्यक आहे",
      ucicRequired: "UCIC आवश्यक आहे",
  ...
  step2: {
    ...
    maturityDoNotRenew: "नूतनीकरण करू नका",
    maturityRenewPrincipal: "मुद्दल नूतनीकरण",
  ...
  otp: {
    ...
    sentToPhone: "ओटीपी {{phoneNumber}} वर पाठवला आहे",
    sentToDevice: "ओटीपी तुमच्या नोंदणीकृत उपकरणावर पाठवला आहे",
    testingHint: "चाचणीसाठी, कृपया ओटीपी वापरा: {{otp}}",
    errors: {
